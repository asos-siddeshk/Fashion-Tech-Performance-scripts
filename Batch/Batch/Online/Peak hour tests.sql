...
select count(*) from rms.item_master where status ='A' and  Item_DESC LIKE '%Jmeter%'
  and item_level ='1' and CREATE_DATETIME>=to_date('08-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi');

select * from rms.item_master where status ='A' and item_level ='1' and Item_DESC LIKE '%Item creation Perf Test%';

select * from rms.item_master where status ='A' and item_level ='1' and Item_DESC LIKE '%Item creation Perf Test%'
        and CREATE_DATETIME>= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi');
...
select count(*) from rms.item_master where status ='A' and item_level ='1'  
   and LAST_UPDATE_DATETIME>=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') and item_desc like '%Jmeter%';
...
select count(*) from rms.item_master  where item_number_type like '%EAN13%' 
   and LAST_UPDATE_DATETIME >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') order by LAST_UPDATE_DATETIME desc; 


-- 67 Maintain Grouping: --120  --624
select count(distinct group_id) from MA_ASOS.ma_group_detail where 
   LAST_UPDATE_DATETIME>=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi'); 

select GROUP_ID,count(1) from MA_ASOS.ma_group_detail where 
   LAST_UPDATE_DATETIME>=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') group by GROUP_ID; 
  
select * from MA_ASOS.MA_GROUP_HEADER;

-- 268 Item Reclassify: --319 -- 1512
select count(*) from ma_asos.MA_STG_ITEM_BUY_HIER_RECLASS where LAST_UPDATE_DATETIME>=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') 
    order by last_update_datetime desc;

select * from ma_asos.MA_STG_ITEM_BUY_HIER_RECLASS where LAST_UPDATE_DATETIME>=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') ;

delete from ma_asos.MA_STG_ITEM_BUY_HIER_RECLASS where LAST_UPDATE_DATETIME>=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi');
...
-- 230 Item Gold Seal --284 -- 
    ...
    where uda_id = '4001' 
    and uil.LAST_UPDATE_DATETIME>=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi')
...
select count(distinct PROCESS_SEQ) from ma_asos.ma_item_mass_mnt_process  mmp 
        where create_datetime >=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi')
...
select * from ma_asos.MA_ITEM_MASS_MNT_HEADER;
...
select count(uil.item) from rms.uda_item_lov uil
    inner join rms.item_master im on (uil.item=im.item and im.item_level ='1')
    where uda_id = '4001' 
    and uil.create_datetime >=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi')
 --   and uil.CREATE_DATETIME <> uil.LAST_UPDATE_DATETIME 
 --   and uil.LAST_UPDATE_DATETIME < to_date('15-JUL-2020 15:45', 'DD-MON-YYYY hh24:mi')
...
select count(*) from rms.item_master where status ='A' 
    and item_level ='1' 
    and upper(Item_DESC) like '%UPLOAD%'
    and CREATE_DATETIME>=to_date('11-OCT-2021 10.00', 'DD-MON-YYYY hh24:mi');
...
select count(*) from rms.ordhead oh where LAST_UPDATE_DATETIME>=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi')
...
select * from ordhead where last_update_datetime>=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi')
        and comment_desc like '%PO Update%'; -- Validate

-- 248 PO Replenishment  -- 1573
select count(*) from rms.ordhead where last_update_datetime >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') 
...
select * from rms.ordhead where last_update_datetime >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi');
...
--25 sku--1
select count(distinct master_po_no)  from rms.ordhead where CREATE_DATETIME>= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi')
...
select master_po_no from rms.ordhead where CREATE_DATETIME>= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi')
                and comment_desc like '%100%';
...
select count(*) from SUPP_ASOS.sc_asnin --520
    ...
    and LAST_UPDATE_DATETIME >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi'); 
...
--84 1259 Create Price  17000
    ...
    select count(1) from ma_asos.ma_price_change where  Status='P' and 
        CREATE_DATETIME  >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') 
        and place_of_creation = 'M';
        
    select * from ma_asos.ma_price_change;
    select status,count(1) from ma_asos.ma_price_change
            where CREATE_DATETIME >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') group by status;

    select status,count(1) from ma_asos.ma_price_change
            where CREATE_DATETIME >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') and CREATE_ID!='PTUSER' group by status;

    select CREATE_ID, count(1) from ma_asos.ma_price_change
            where CREATE_DATETIME >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') and CREATE_ID!='PTUSER' group by CREATE_ID ;
    ...
    select im.dept,pc.EFFECTIVE_DATE,pc.CREATE_ID,pc.status, count(1) from ma_asos.ma_price_change pc, item_master im 
            where im.item= pc.item and pc.CREATE_DATETIME >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') 
    ...
    select pc.EFFECTIVE_DATE,pc.CREATE_ID,pc.status, count(1) from ma_asos.ma_price_change pc
            where pc.CREATE_DATETIME >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') 
            group by pc.EFFECTIVE_DATE,pc.CREATE_ID,pc.status ;
            
 select dept,count(1) from item_master where item in 
    (select distinct item from ma_asos.ma_price_change where CREATE_DATETIME >= to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi')) 
    group by dept;
...
--46/2062 Copy Promotion --1224
    select count(1) from ma_asos.ma_stage_simple_promo where last_update_datetime >=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi');

    select COMP_DISPLAY_ID,count(1) from ma_asos.ma_stage_simple_promo where last_update_datetime >=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi') group by COMP_DISPLAY_ID;
...
--3300 Price Upload--9050 -- 2600
    ...
    select count(*) from ma_asos.ma_price_change where create_datetime >=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi')
        and place_of_creation='U';
    
    select * from ma_asos.ma_price_change where create_datetime >=to_date('03-DEC-2021 10.00', 'DD-MON-YYYY hh24:mi')
        and place_of_creation='U';
...
--Upload Brand Conversion --58 -ff- 292
    select count(*) from ma_asos.MA_PRICING_RULES_METHOD
        where CREATE_DATETIME >= to_date('01-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi'); -- verify

    select * from ma_asos.MA_PRICING_RULES_METHOD
        where CREATE_DATETIME >= to_date('08-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi'); -- verify

    select count(*) from ma_asos.MA_PRICING_RULES_METHOD
        where CREATE_DATETIME >= to_date('08-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi'); -- verify

-- 71 Cost Change --132-- 431
  select count(1) from ma_asos.ma_cost_change where CREATE_DATETIME  >= to_date('08-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi') ;

  select * from ma_asos.ma_cost_change where CREATE_DATETIME  >= to_date('08-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi') ;



select * from ITeM_MASTeR WHeRe ITeM_PAReNT = '100843040';
select * from ITeM_MASTeR WHeRe ITeM_PAReNT = '100012953';


select * from ma_asos.MA_PRICING_RULES_METHOD where CREATE_DATETIME >= to_date('08-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi'); 

delete from ma_asos.MA_PRICING_RULES_DEF where id in (select id from ma_asos.MA_PRICING_RULES_METHOD where CREATE_DATETIME >= to_date('08-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi'));
delete from ma_asos.MA_PRICING_RULES_DEF where PARENT_ID in (select id from ma_asos.MA_PRICING_RULES_METHOD where CREATE_DATETIME >= to_date('08-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi'));
delete from ma_asos.MA_PRICING_RULES_DEF where RULES_METHOD_ID in (select id from ma_asos.MA_PRICING_RULES_METHOD where CREATE_DATETIME >= to_date('08-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi'));
delete from ma_asos.MA_PRICING_RULES_METHOD where CREATE_DATETIME >= to_date('08-DEC-2021 10.45', 'DD-MON-YYYY hh24:mi'); 
