...
select * from ma_asos.MA_ORDER_REC_HEAD_STG;


select * from ma_asos.ma_v_planning;

select * from ma_asos.ma_v_replenishment;
select UPLOAD_ID, UPLOAD_CREATE_DATE,count(1) from ma_asos.ma_v_planning group by UPLOAD_ID, UPLOAD_CREATE_DATE;


select order_no,count(1) from rms.ordsku group by order_no;
...
select * from ma_asos.MA_ORDER_REC_HEAD_STG  where REC_SOURCE = 'P' and trunc(CREATE_DATETIME) ='10-MAR-22';
select * from ma_asos.MA_ORDER_REC_DETAIL_STG  where ORDER_REC_NO  in (select ORDER_REC_NO from ma_asos.MA_ORDER_REC_HEAD_STG  where REC_SOURCE = 'P' and trunc(CREATE_DATETIME) ='10-MAR-22'); 

delete from ma_asos.MA_ORDER_REC_HEAD_STG  where REC_SOURCE = 'P' and trunc(CREATE_DATETIME) ='10-MAR-22';
delete from ma_asos.MA_ORDER_REC_DETAIL_STG  where ORDER_REC_NO  in (select ORDER_REC_NO from ma_asos.MA_ORDER_REC_HEAD_STG  where REC_SOURCE = 'P' and trunc(CREATE_DATETIME) ='10-MAR-22'); 
                ...
                select * from (
                  select distinct im.item_parent,iss.supplier
                        ...
                        where so.item= im.item_parent	
                            ...
                            and im.item_desc = 'Item creation Perf Test'
--                            and iss.supplier = '1100000086'
                            --and im.CREATE_DATETIME>= to_date('10-NOV-2021 08.20', 'DD-MON-YYYY hh24:mi')
