...
l_invoicereference          varchar2(100) := 'APR027';
l_paymentreference          varchar2(6)   := 'APR027';
l_orderid                   varchar2(20)  := 'APR027';
...
cursor c_item_loc is 
 ...
 where il.STOREID ='20004' and not exists (select 1 from skumar.CASHANDSALES_ALL ca where ca.sku=il.SKUITEMID and WLOCATION = l_wlocation)
   and rownum<=3;
...
COUNTER_COMMIT  NUMBER(8)     := 1;
l_invoicereference          varchar2(100) := 'APR028';
l_paymentreference          varchar2(6)   := 'APR028';
l_orderid                   varchar2(20)  := 'APR028';
l_discounttotalamount       number(20,4)  := 0;
l_discountcode              varchar2(10)  := 'moreplease';
l_discounttype              varchar2(20)  := 'Percentage';
l_discountvalue             number(20,4)  := 0;
l_wlocation                 varchar2(10)  := 'FC04';
l_stockreference            NUMBER(15)    := '168';
l_sku                       varchar2(25)  ;
l_quantity                  number(20,4)  := 3;
l_currentprice              number(20,4)  ;
l_deliverycountrycode       varchar2(2)   := 'DE';
l_orderreference            varchar2(20)  := 'APR028';
l_idorconversionid          number(10)    := '168';
l_currencycode              varchar2(3)   := 'EUR';
l_action                    varchar2(3)   := 'E';
l_code                      varchar2(20)  := 'Receipt Return';
l_returnqty                 number(20,4)  := 1;
l_user_def_type_4           varchar2(20)  := 'APR028';
l_lock_code                 varchar2(20)  := 'AQL';
l_ordertype                 varchar2(20)  := 'Consumer';
l_location      rms.item_loc.loc%type := '20004';
l_priceversion_id           varchar2(80)  ;
...
cursor c_item_loc is 
  select   PRICEVERSIONID as priceversionid, SKUITEMID as item, SELLINGUNITRETAILPRICE as selling_unit_retail
  from skumar.Cashandsales_int il  
 where il.STOREID ='20004' and not exists (select 1 from skumar.CASHANDSALES_ALL_2 ca where ca.sku=il.SKUITEMID and WLOCATION = l_wlocation)
   and rownum<=3;
...
COUNTER_COMMIT  NUMBER(8)     := 1;
l_invoicereference          varchar2(100) := 'APR029';
l_paymentreference          varchar2(6)   := 'APR029';
l_orderid                   varchar2(20)  := 'APR029';
l_discounttotalamount       number(20,4)  := 0;
l_discountcode              varchar2(10)  := 'moreplease';
l_discounttype              varchar2(20)  := 'Percentage';
l_discountvalue             number(20,4)  := 0;
l_wlocation                 varchar2(10)  := 'FC04';
l_stockreference            NUMBER(15)    := '169';
l_sku                       varchar2(25)  ;
l_quantity                  number(20,4)  := 3;
l_currentprice              number(20,4)  ;
l_deliverycountrycode       varchar2(2)   := 'DE';
l_orderreference            varchar2(20)  := 'APR029';
l_idorconversionid          number(10)    := '169';
l_currencycode              varchar2(3)   := 'EUR';
l_action                    varchar2(3)   := 'E';
l_code                      varchar2(20)  := 'Receipt Return';
l_returnqty                 number(20,4)  := 1;
l_user_def_type_4           varchar2(20)  := 'APR029';
l_lock_code                 varchar2(20)  := 'AQL';
l_ordertype                 varchar2(20)  := 'Consumer';
l_location      rms.item_loc.loc%type := '20004';
l_priceversion_id           varchar2(80)  ;
...
cursor c_item_loc is 
    select   PRICEVERSIONID as priceversionid, SKUITEMID as item, SELLINGUNITRETAILPRICE as selling_unit_retail
      from skumar.Cashandsales_int il  
     where il.STOREID ='20004' and not exists (select 1 from skumar.CASHANDSALES_ALL_3 ca where ca.sku=il.SKUITEMID and WLOCATION = l_wlocation)
       and rownum<=3;
