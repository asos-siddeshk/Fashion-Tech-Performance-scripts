...
select * from int_asos.INT_PO_COMMITMENT; --prod -> 2626704 /  vpt -> 1519410

select count(1) from int_asos.INT_PO_COMMITMENT; --prod -> 1465456 /  vpt -> 1519410
select count(1) from rms.shipment; --prod -> 105M /  vpt -> 330M
select count(1) from tsfhead; --prod -> 445M  /  vpt -> 281M



select * from int_asos.INT_PO_COMMITMENT; --prod -> 1465456 /  vpt -> 1519410
select * from int_asos.INT_DEL_SCHED_DNLD_STG; --prod -> 280k /  vpt -> 285k

--Baseline
select count(1) from int_asos.INT_PO_COMMITMENT; --prod -> 1465456 /  vpt -> 1535766
select count(1) from int_asos.INT_DEL_SCHED_DNLD_STG; --prod -> 280852 /  vpt -> 289801

select count(1) from int_asos.INT_PO_COMMITMENT; --prod -> 1473739 /  vpt -> 1535766
select count(1) from int_asos.INT_DEL_SCHED_DNLD_STG; --prod -> 281914 /  vpt -> 289801
