select ACTIVE_DATE,STATUS,count(1) from cost_susp_sup_head group by ACTIVE_DATE,STATUS order by ACTIVE_DATE,STATUS; --26-AUG-18	13500
select vdate-99 from rms.period;
select * from cost_susp_sup_head;
select * from cost_susp_sup_detail;
