...
select * from rms.cost_susp_sup_head order by 1 desc;
select * from rms.cost_susp_sup_head where status! ='A' order by 1 ;

select * from rms.cost_susp_sup_head where trunc(active_date)='16-JAN-24' and status! ='A' order by 1 desc;
select * from rms.cost_susp_sup_detail where COST_CHANGE in (select COST_CHANGE from rms.cost_susp_sup_head where trunc(active_date)='16-JAN-24' and status ='A');
...
select * from rms.cost_susp_sup_detail where cost_change = '23875643';
select * from rms.cost_susp_sup_head where cost_change = '23875643';

select * from rms.item_master where item_parent ='100306345';
select * from rms.item_supplier where item ='100306345';

select * from rms.future_cost where item ='7582378' order by ACTIVE_DATE desc;

RMS.NB_INT_EC_TABLE_OLEX_AIUDR
