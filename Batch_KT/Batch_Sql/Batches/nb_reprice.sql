...
select state,count(1) from rms.rpm_price_change where EFFECTIVE_DATE between '08-MAY-21' and '10-MAY-21' group by state; -- 5008
pricechange.state.approved	24185
pricechange.state.worksheet	443
pricechange.state.executed	118063
...
l_loc				rms.ITEM_LOC_CFA_EXT.loc%type  := '20013';
