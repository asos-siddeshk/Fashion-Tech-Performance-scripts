...
SELECT system_options.tsf_history_mths,
     ...
     select CLOSE_DATE,count(1) from tsfhead where CLOSE_DATE <= '01-OCT-18' group by CLOSE_DATE order by CLOSE_DATE;        
...
select * from ordcust where tsf_no in ('7010263909');
select * from ordcust_detail where ORDCUST_NO  in (9191025,10896137);
select * from rms.tsfhead where tsf_no in ('7010263909');
select * from rms.tsfdetail where tsf_no in ('7010263909');
select * from rms.shipment where shipment in (select shipment from rms.shipSKU where DISTRO_NO in ('7010263909'));
select * from rms.shipSKU where DISTRO_NO in ('7010263909');
select * from rms.shipSKU_loc where shipment in (select shipment from rms.shipSKU where DISTRO_NO in ('7010263909'));
select * from rms.DOC_CLOSE_QUEUE where doc in ('7010263909');
select * from rms.item_loc_soh where  (item,loc) in (select ITEM, LOCATION from rms.tran_data where ref_no_1 in ('7010263909'));
select * from rms.tran_data where ref_no_1 in ('7010263909') order by item,location,tran_code;
