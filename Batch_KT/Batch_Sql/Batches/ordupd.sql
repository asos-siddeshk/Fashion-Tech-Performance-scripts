 WITH phist AS
              (select item, 10 as unit_retail, LOCATION as loc, effective_date as action_date from rpm_price_change where effective_date ='03-DEC-18')
       SELECT distinct 'S',
              oh.order_no,
              oh.currency_code,
              '0' pack_no,
       ...
       and ol.location = ph.loc
          ...
          select * from rpm_price_change where effective_date ='03-DEC-18' and ZONE_NODE_TYPE ='2';
