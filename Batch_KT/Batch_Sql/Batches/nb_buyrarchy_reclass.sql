...
select * from BRAND where BRAND_NAME like 'TR%';
...
select * from ma_asos.MA_item_attributes where business_model = '3';
...
declare
	...
	l_business_model	 ma_asos.ma_stg_item_buy_hier_reclass.business_model%type	:=3;
	l_buying_group		 ma_asos.ma_stg_item_buy_hier_reclass.buying_group%type		:=199;
	l_buying_subgroup	 ma_asos.ma_stg_item_buy_hier_reclass.buying_subgroup%type	:=24;
	l_buying_set		 ma_asos.ma_stg_item_buy_hier_reclass.buying_set%type		:=74;
    L_EFFECTIVE_DATE     ma_asos.ma_stg_item_buy_hier_reclass.EFFECTIVE_DATE%type;
