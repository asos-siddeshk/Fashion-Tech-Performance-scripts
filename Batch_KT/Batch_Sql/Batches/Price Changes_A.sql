    ...
    p_change_selling_uom    ma_asos.ma_stage_price_change.change_selling_uom%type;	 
	 ...
	 CURSOR c_get_cuitem_pc is
				select  price_change_id, 
						...
						change_currency, 
						change_selling_uom 						
            from rms.rpm_price_change rpc where state like 'pricechange.state.approved' and rpc.ZONE_NODE_TYPE ='0'
                and effective_date >='02-MAR-2020' and rownum <='800'
...
BEGIN    
   FOR cust_ma in c_get_cuitem_pc Loop
			...
			p_change_percent	:= cust_ma.change_percent; 
