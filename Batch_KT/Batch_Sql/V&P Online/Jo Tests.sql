...
select * from ma_asos.MA_STG_UPLOAD_PROCESS where process_seq= '28895';


select * from ma_asos.MA_STG_UPLOAD_PROCESS where process_seq= '28895';
select * from ma_asos.MA_STG_UPLOAD_PROCESS_LINE where process_seq= '28895';
select * from ma_asos.MA_STG_UPLOAD_PROCESS_LINE_IDS where process_seq= '28895';
select * from ma_asos.MA_STG_UPLOAD_BOUNDED_ATTR where process_seq= '28895';
select * from ma_asos.MA_STG_UPLOAD_UNBOUNDED_ATTR where process_seq= '28895';
...
select PROCESS_SEQ, ITEM, STATUS, ERROR_MESSAGE, ERROR_MESSAGE_DETAIL,
       ...
       to_char(LAST_UPDATE_DATETIME,'dd-mon-yy hh:mi:ss am') LAST_UPDATE_DATETIME,
        CREATE_ID, LAST_UPDATE_ID
from ma_asos.ma_item_mass_mnt_process where PROCESS_SEQ in ('6800') 
   -- and status = 'P'
    order by LAST_UPDATE_DATETIME desc;
