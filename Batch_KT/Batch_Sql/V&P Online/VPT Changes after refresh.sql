...
from DIFF_GROUP_HEAD where diff_group_id = '3064';
...
select * from DIFF_GROUP_DETAIL;
Waist Plus W30L36-W48L34
...
Insert into DIFF_GROUP_HEAD (DIFF_GROUP_ID,DIFF_TYPE,DIFF_GROUP_DESC,CREATE_DATETIME,LAST_UPDATE_ID,LAST_UPDATE_DATETIME,FILTER_ORG_ID,FILTER_MERCH_ID,FILTER_MERCH_ID_CLASS,FILTER_MERCH_ID_SUBCLASS,CREATE_ID) 
    values ('3064','S','Waist Plus W30L36-W48L34',to_date('30-SEP-19','DD-MON-RR'),'ORACNV',to_date('30-SEP-19','DD-MON-RR'),null,2,null,null,'ORACNV');
