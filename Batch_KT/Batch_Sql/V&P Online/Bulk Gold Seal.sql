...
delete from rms.skulist_head where sKULIST_DESC like 'Bulk Gold Seal%';
delete from rms.skulist_detail where skulist in (select skulist from rms.skulist_head where sKULIST_DESC like 'Bulk Gold Seal%');
delete from rms.skulist_criteria where skulist in (select skulist from rms.skulist_head where sKULIST_DESC like 'Bulk Gold Seal%');
...
for m in 0..45 loop 
   ...
   select RMS.LIST_SEQUENCE.nextval into l_REF_NO from dual;
   		l_itemlist_desc	:= 'Bulk Gold Seal'||'-'||l_REF_NO;
		I_filename 		:= 'Bulk Gold Seal'||'-'||l_REF_NO;
